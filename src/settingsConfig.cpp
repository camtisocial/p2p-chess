...
void seeColorOptions() {
    ...
    std::cout << std::string(terminalWidth-(terminalWidth*0.15), ' ') + "(usr/share/terminalChess/settings.ini)" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "\x1B[1;92m" << std::string(terminalWidth, ' ') + "This is bright_green" << "\033[0m" << std::endl;
    std::cout << "\x1B[1;93m" << std::string(terminalWidth, ' ') + "This is bright_yellow" << "\033[0m" << std::endl;
    std::cout << "\x1B[1;94m" << std::string(terminalWidth, ' ') + "This is bright_blue" << "\033[0m" << std::endl;
    std::cout << "\x1B[1;95m" << std::string(terminalWidth, ' ') + "This is bright_magenta" << "\033[0m" << std::endl;
    std::cout << "\x1B[1;96m" << std::string(terminalWidth, ' ') + "This is bright_cyan" << "\033[0m" << std::endl;
